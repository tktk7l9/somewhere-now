...
- 収録 **5,711 地点**・118 の国と地域（街・自然・動物・空港・港・火山・鉄道・宇宙）
- 平面図と**地球儀**を切り替え（ピンの琥珀は配信中、黒は停止）
- 選んだ場所の**現地時刻**と**いまの天気**を表示
- 最大 4 枚を 2×2 で**並べて見る**
- 配信中を**視聴が多い順**に一覧できる
- **いまいる場所へ** — 地図を現在地に寄せ、いちばん近くで配信中のカメラをパネルに開く
- **音はどこでも既定でミュート**（職場で開いて音が出る事故を避ける。出す選択は覚えておく）
- 日本語 / English
...
再探索は **チャンネル単位** でまとめる。5,711 台が 2,450 チャンネルにぶら下がっている
