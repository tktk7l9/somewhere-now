...
| 再探索（uploads を辿る） | 2〜6 units / チャンネル | 毎時・最大 24 チャンネル | 0〜3,456 | 4,000 |
...
検索（101 units）に後退する。後退は 1 回の実行で 1 チャンネルまで。非ライブのカメラは
806 チャンネルに散っているので、毎時 24 本で **1.4 日**で一周する。生存確認の方が先で、
