...
const CITY_QUERIES: Query[] = [
  ...
  { q: "live webcam Oregon coast", countryCode: "US", note: "オレゴン" },
  { q: "live webcam Washington state", countryCode: "US", note: "ワシントン州" },
  { q: "live webcam Louisiana", countryCode: "US", note: "ルイジアナ" },
  { q: "live webcam Maine harbor", countryCode: "US", note: "メイン" },
  { q: "live webcam Vermont", countryCode: "US", note: "バーモント" },
  { q: "live webcam Arizona desert", countryCode: "US", note: "アリゾナ" },
  { q: "live webcam Nevada", countryCode: "US", note: "ネバダ" },
  { q: "live webcam Utah", countryCode: "US", note: "ユタ" },
  { q: "live webcam New Mexico", countryCode: "US", note: "NM" },
  { q: "live cam railway crossing USA", countryCode: "US", note: "踏切US" },
  { q: "live cam marina Florida", countryCode: "US", note: "FLマリーナ" },
  { q: "live cam pier California", countryCode: "US", note: "CA桟橋" },
  { q: "live webcam Hokkaido", countryCode: "JP", note: "北海道EN" },
  { q: "live webcam Kyushu Japan", countryCode: "JP", note: "九州" },
  { q: "live webcam Shikoku", countryCode: "JP", note: "四国" },
  { q: "ライブカメラ 北海道", countryCode: "JP", note: "北海道JP" },
  { q: "ライブカメラ 東北", countryCode: "JP", note: "東北" },
  { q: "ライブカメラ 北陸", countryCode: "JP", note: "北陸" },
  { q: "ライブカメラ 四国", countryCode: "JP", note: "四国JP" },
  { q: "ライブカメラ 九州", countryCode: "JP", note: "九州JP" },
  { q: "live cam Busan harbor", countryCode: "KR", note: "釜山港" },
  { q: "live cam Taiwan street", countryCode: "TW", note: "台湾街" },
  { q: "live cam Philippines beach", countryCode: "PH", note: "PH浜2" },
  { q: "live cam Vietnam beach", countryCode: "VN", note: "VN浜" },
  { q: "live cam Malaysia beach", countryCode: "MY", note: "MY浜" },
  { q: "live cam Indonesia volcano", countryCode: "ID", note: "ID火山" },
  { q: "live cam India temple", countryCode: "IN", note: "IN寺" },
  { q: "live cam Nepal mountain", countryCode: "NP", note: "NP山" },
  { q: "live cam UAE marina", countryCode: "AE", note: "UAE" },
  { q: "live cam Egypt Nile", countryCode: "EG", note: "ナイル" },
  { q: "live cam Morocco medina", countryCode: "MA", note: "メディナ" },
  { q: "live cam South Africa safari", countryCode: "ZA", note: "ZAサファリ" },
  { q: "live cam Kenya wildlife", countryCode: "KE", note: "ケニア" },
  { q: "live cam Brazil beach 24/7", countryCode: "BR", note: "BR浜3" },
  { q: "live cam Argentina plaza", countryCode: "AR", note: "AR広場" },
  { q: "live cam Chile coast", countryCode: "CL", note: "CL海岸" },
  { q: "live cam Peru plaza", countryCode: "PE", note: "PE" },
  { q: "live cam Colombia city", countryCode: "CO", note: "CO" },
  { q: "live cam Mexico beach 24/7", countryCode: "MX", note: "MX浜2" },
  { q: "live cam Caribbean beach", countryCode: "DO", note: "カリブ" },
  { q: "live cam Iceland volcano", countryCode: "IS", note: "IS火山2" },
  { q: "live cam Scotland highlands", countryCode: "GB", note: "スコットランド" },
  { q: "live cam Wales coast", countryCode: "GB", note: "ウェールズ" },
  { q: "live cam Ireland coast", countryCode: "IE", note: "アイルランド浜" },
  { q: "live cam Belgium beach", countryCode: "BE", note: "BE浜" },
  { q: "live cam Denmark harbor", countryCode: "DK", note: "DK港" },
  { q: "live cam Sweden ski", countryCode: "SE", note: "SEスキー" },
  { q: "live cam Finland lapland", countryCode: "FI", note: "FIラップランド" },
  { q: "live cam Poland beach", countryCode: "PL", note: "PL浜" },
  { q: "live cam Croatia harbor", countryCode: "HR", note: "HR港" },
  { q: "live cam Greece island", countryCode: "GR", note: "GR島2" },
  { q: "live cam Turkey beach 24/7", countryCode: "TR", note: "TR浜2" },
  { q: "live cam Portugal beach 24/7", countryCode: "PT", note: "PT浜2" },
  { q: "live cam Spain beach 24/7", countryCode: "ES", note: "ES浜3" },
  { q: "live cam Italy beach 24/7", countryCode: "IT", note: "IT浜3" },
  { q: "live cam France beach 24/7", countryCode: "FR", note: "FR浜3" },
  { q: "live cam Germany beach 24/7", countryCode: "DE", note: "DE浜3" },
  { q: "live cam Netherlands beach", countryCode: "NL", note: "NL浜" },
  { q: "live cam Switzerland ski 24/7", countryCode: "CH", note: "CHスキー2" },
  { q: "live cam Austria ski 24/7", countryCode: "AT", note: "ATスキー2" },
  { q: "live cam Australia beach 24/7", countryCode: "AU", note: "AU浜3" },
  { q: "live cam New Zealand beach", countryCode: "NZ", note: "NZ浜" },
  { q: "live cam Fiji", countryCode: "FJ", note: "フィジー" },
  { q: "live cam Maldives", countryCode: "MV", note: "モルディブ" },
  { q: "live cam Seychelles", countryCode: "SC", note: "セイシェル" },
  { q: "earthcam live", countryCode: "US", note: "EarthCam一般" },
  { q: "skylinewebcams live", countryCode: "IT", note: "Skyline一般" },
  { q: "explore.org live cam", countryCode: "US", note: "explore一般" },
];
