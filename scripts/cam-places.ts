...
export const CAM_PLACES_CURATED: CamPlace[] = [
  ...
  // (地図アプリとしての置き場。Open-Meteo で Texas の Houston を解決)。
  {
    ...
    nameEn: "ISS Earth View (NASA)",
    category: "space",
    handle: "NASA",
    channelId: "UCLA_DiR1FfKNvjuUpBHmylQ",
    videoId: "M3HKLzjvKPc",
    titleKey: "Live Video from the International Space Station (Official NASA Stream)",
    place: { name: "Houston", countryCode: "US", admin1: "Texas" },
  },
  {
    id: "iss-hd-nasa",
    nameJa: "ISS 高精細地球ライブ（NASA）",
    nameEn: "ISS HD Earth View (NASA)",
    category: "space",
    handle: "NASA",
    channelId: "UCLA_DiR1FfKNvjuUpBHmylQ",
    videoId: "awQzjn72bI0",
  ...
  {
    id: "starbase-live",
    nameJa: "Starbase（SpaceX ボカチカ）",
    nameEn: "Starbase, Boca Chica (SpaceX)",
    category: "space",
    ...
    place: { name: "Starbase", countryCode: "US", admin1: "Texas" },
  },
  {
    id: "space-coast-live",
    nameJa: "スペースコースト（ケープカナベラル）",
    nameEn: "Space Coast, Cape Canaveral",
    category: "space",
    handle: "NASASpaceflight",
    channelId: "UCSUu1lih2RifWkKtDOJdsBA",
    videoId: "Jm8wRjD3xVA",
    ...
    place: { name: "Cape Canaveral", countryCode: "US", admin1: "Florida" },
  },
  {
    id: "mcgregor-spacex",
    nameJa: "マクグレガー（SpaceX エンジン試験）",
    nameEn: "McGregor SpaceX Engine Test",
    category: "space",
    handle: "NASASpaceflight",
    channelId: "UCSUu1lih2RifWkKtDOJdsBA",
    videoId: "cOmmvhDQ2HM",
